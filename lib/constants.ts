// Real contact + social details for Time to Surf.
export const TELEGRAM_USERNAME = "Andrei_Time_to_Surf";
export const TELEGRAM_URL = `https://t.me/${TELEGRAM_USERNAME}`;
export const PHONE_DISPLAY = "+372 55 512 872";
export const PHONE_TEL = "+37255512872";
export const EMAIL = "info.timetosurf@gmail.com";
